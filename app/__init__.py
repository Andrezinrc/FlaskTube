...
def baixar_video():
    ...
    try:
        ...
        caminho_salvar = "/storage/emulated/0/Download/meu_pytube_video"
...
def baixar_musica():
    ...
    try:
        url = request.args.get("url")
        caminho_salvar = "/storage/emulated/0/Download/meu_pytube_musica"
...
def ver_videos():
    caminho_video = "/storage/emulated/0/Download/meu_pytube_video"
...
def ver_musicas():
    caminho_musica = "/storage/emulated/0/Download/meu_pytube_musica"
